    ...
    <div class="team-section">
        <div class="container transparan">
            ...
            <div align="center" class="mb-30">
                <img src="assets/imgs/b_sc.png" class="tulisan_tac" alt=""/> 
            </div>
            ...
            {{-- <div class="d-flex justify-content-center align-items-center mb-30">
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                        <li><a class="dropdown-item" href="{{ route('star-club').'?q=l' }}">Leader </a></li>
                        <li><a class="dropdown-item" href="{{ route('star-club').'?q=p' }}">Producer </a></li>
                    </ul>
                </div> 
            </div> --}}
            ...
            <div class="d-flex justify-content-center align-items-center mb-30">
                <div class="flat-select-container">
                    <select id="top-regional-area" class="flat-select" name="kategori_pilihan" onchange="goSubCategory('{{ route('star-club').'?q=' }}'+this.value);">
